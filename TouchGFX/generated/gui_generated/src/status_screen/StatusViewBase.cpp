...
StatusViewBase::StatusViewBase() :
    updateItemCallback(this, &StatusViewBase::updateItemCallbackHandler)
{
...
void StatusViewBase::handleKeyEvent(uint8_t key)
{
    if(0 == key)
    {
        //Interaction1
...
void StatusViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
