...
AdvancedViewBase::AdvancedViewBase() :
    updateItemCallback(this, &AdvancedViewBase::updateItemCallbackHandler)
{
    ...
    scrollWheel1.setNumberOfItems(21);
...
void AdvancedViewBase::setupScreen()
{
...
void AdvancedViewBase::handleKeyEvent(uint8_t key)
{
    if(0 == key)
    {
        //Interaction1
        //When hardware button 0 clicked change screen to Status
        //Go to Status with screen transition towards West
        application().gotoStatusScreenSlideTransitionWest();
    }
}

void AdvancedViewBase::updateItemCallbackHandler(touchgfx::DrawableListItemsInterface* items, int16_t containerIndex, int16_t itemIndex)
{
